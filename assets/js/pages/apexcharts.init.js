...
barchartColors = getChartColorsArray("basic_pyramid_area"), options = {
    series: [{
        name: "",
...
(chart = new ApexCharts(document.querySelector("#basic_pyramid_area"), options)).render();
barchartColors = getChartColorsArray("basic_recruitment_area"), options = {
    series: [{
        name: "Funnel Series",
...
(chart = new ApexCharts(document.querySelector("#basic_recruitment_area"), options)).render();